...
<!-- Modal para exclução de usuario -->

<div id="modal-delete" class="modal-background" style="display:none;">
    <div class="section-container">
        <div class="modal-container" style="border: 2px solid #f07c10ff;">
            <div class="modal">
                <div class="modal-cabecalho">
                    <span style="color:#f07c10ff ;"><i class='fa-solid fa-triangle-exclamation'></i> Alerta!</span>
                </div>
                <div class="modal-descricao">
                    <p>Tem certeza que deseja apagar o registro do dia?</p>
                    <span class="span-data-remocao" id="data-remocao"></span>
                </div>
                <form action="./settings/delete_registro.php" method="post">
                    <input type="hidden" name="data" id="data_delete">
                    <div class="btn-modal ">
                        <button type="submit" class="btn-confirmar btn-padrao btn-alertar">Confirmar</button>
                        <button type="button" class="btn-padrao btn-alertar" onclick="fechar_modal()" class="btn-cancelar">Cancelar</button>
                    </div>
                </form>
            </div>
        </div>
...
<div id="modal-justificativa" class="modal-background">
    <div class="section-container">
            ...
            <div class="modal">
                <form action="./settings/conf_justificativa.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-descricao">
                        ...
                        <div class="input-colunm grid-justificativa">
                            ...
                            <div class="item-justificativa">
                                ...
                                <input class='input-justificativa' min="1" value="1" step="1" name="dias_atestado" id="input-dias-atestados" type="number">
                            </div>
                            <div>
                    ...
                    <div class="btn-modal ">
                        ...
                        <button type="button" class="btn-padrao" onclick="fechar_modal()" class="btn-cancelar">Cancelar</button>
                    </div>
                </form>
            </div>
        </div>
